...
namespace Svelto.ECS.Example.Survive {
    class EnemyFactory : IEnemyFactory {
        ...
        public void Build(EnemySpawnData enemySpawnData, ref EnemyAttackStruct enemyAttackstruct) {
            ...
            using (profiler.StartNewSession("BuildEnemy")) {
                ...
                using (profiler.Sample("BuildEntity"))
                    initializer = _entityFactory.BuildEntity<EnemyEntityDescriptor>(
                        new EGID(go.GetInstanceID(), ECSGroups.ActiveEnemies), implementors);
        ...
        public void Preallocate() => _entityFactory.PreallocateEntitySpace<EnemyEntityDescriptor>(ECSGroups.ActiveEnemies, 10);
